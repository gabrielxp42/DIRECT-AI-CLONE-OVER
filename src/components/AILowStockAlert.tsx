...
export const AILowStockAlert = () => {
    ...
    const message = lowStockItems.length === 1
        ? `Ei! Notei que o estoque de ${lowStockItems[0].nome} está no limite!`
        : `Ei! Temos ${lowStockItems.length} itens no estoque abaixo do mínimo!`;
            ...
            <div className="relative max-w-sm mx-auto md:max-w-none">
                ...
                <div className="bg-red-500/80 dark:bg-red-600/80 backdrop-blur-xl text-white px-4 py-3 md:px-6 md:py-3.5 rounded-2xl md:rounded-br-none shadow-[0_20px_50px_rgba(239,68,68,0.4)] border border-white/20 flex items-center gap-3 md:gap-4 animate-bounce-slow">
                    ...
                    <div className="flex flex-col min-w-0">
                        ...
                        <span className="text-xs md:text-sm font-bold leading-tight drop-shadow-sm truncate md:whitespace-normal">{message}</span>
                    </div>
