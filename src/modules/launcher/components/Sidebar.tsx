  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-cyan-400/20 to-blue-600/20 border border-white/20 flex items-center justify-center text-2xl font-black text-white shadow-xl">
           G
        </div>
        <div>
           <h2 className="text-xl font-black text-white tracking-tight">Gabriel</h2>
           <p className="text-white/40 text-xs font-bold uppercase tracking-widest">Administrador</p>
        </div>
      </div>
      ...
      <div className="mt-auto">
        <button className="flex items-center gap-3 p-3 rounded-2xl w-full text-rose-400/60 hover:text-rose-400 hover:bg-rose-500/5 transition-all text-sm font-bold">
          <LogOut size={18} />
